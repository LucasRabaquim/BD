...
delimiter $$
 ...
 create procedure spInsertClientePf(vNomeCli varchar(200), vNumEnd decimal(6,0), vCompEnd varchar(50), vCepCli decimal(8,0), vCpf decimal(11,0), vRg decimal(9,0), vRg_Dg char(1), 
 vNasc date)
 begin
	...
	set @idCli = (select IdCli from tbClientePf where CPF = vCpf);
...
/*call spInsertClientePf("Disney Chaplin",89,null,12345051,12345678911,12345678,"0","2000/10/12");
call spInsertClientePf("Pimpão",325,null,12345051,12345678911,12345678,"0","2000/10/12");
call spInsertClientePf("Pimpão",325,null,12345051,12345678911,12345678,"0","2000/10/12");*/
describe tbEndereco;
