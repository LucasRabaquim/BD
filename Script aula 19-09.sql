...
alter table tb_ProdutoHistorico add Ocorrencia varchar(100);

-- 18)
alter table tb_ProdutoHistorico 
add constraint pk_ProdHist primary key (CodigoBarras,Atualizacao,Ocorrencia);

-- 19)
describe tbProduto;
delimiter // 
create trigger TGR_InsertProdutoHistorico after insert on tbProduto
for each row
begin
